...
//  - Dashboard stats come from the fixtures (6 assets, 4 non-terminal WOs)
...
describe('DashboardScreen (mock mode)', () => {
  it('renders stats and the work-order table from the fixtures', async () => {
    ...
    // 6 fixture assets; 5 fixture WOs of which one is Closed
    await waitFor(() => expect(statValue('Assets')).toBe('6'));
