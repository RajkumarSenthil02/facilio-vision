// Minimal int8 quantized-vector helpers for the AR relocalization lane.
// Lifted from asset-lens src/vision/quantize.ts. TEMPORARY DUPLICATION:
// src/vision (parallel workstream) ships the canonical copy — the integrator
// dedupes these imports once both land.
//
...
/** int8+base64 quantized embedding — the SweepFrame.vec wire shape. */
